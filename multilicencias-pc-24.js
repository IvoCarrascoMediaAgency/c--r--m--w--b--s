      ...
      'C2':{
         items:{
            ...
            'I1':{
                ...
                detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i>5 cuentas CRM WhatsApp 30 Días</li><li><i class="fas fa-stop-circle"></i> Mensajes y Campañas Ilimitadas</li><li><i ></i> Mensajes 100% Personalizados</li><li><i ></i>Adjunta Video, Imagen, Audio, Catálogos, Documentos</li> <li> <i></i>Importación de Contactos.</li> <li> <i></i>Sistema Anti-Algoritmo de Bloqueo</li>  <li> <i ></i>Envía Imágenes y Videos con Descripción</li><li> <i ></i>Programar campañas masivas</li><li> <i ></i>Gestión de contactos</li><li> <i ></i>Genera embudos de venta</li><li> <i ></i>ChatBot + WorkFlow + Menús</li><li> <i ></i>Crea Reglas Automatizadas</li> <li> <i ></i>Crea recordatorios recurrentes</li> <li> <i ></i>Agrega atributos personalizados CRM</li><li> <i ></i>Crea recordatorios y notas de trabajo</li><li><li> <i ></i>Crea respuestas rápidas</li><li> <i ></i>Genera Plantillas</li><li> <i ></i>Exporta e importa Backups</li><li> <span class="masc">Soporte</span></li><li><span class="masc">Capacitación con Tutoriales</span></li></ul></div></div>',
            ...
            'I2':{
                name:'PRO Business 12 meses',
                antes:479.98,
                price:239.99,
                qty:0,
                img:'img/imgproduc/crm-whatsapp-business.webp',
                detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li><i></i>5 cuentas CRM WhatsApp 12 Meses</li><li><i class="fas fa-stop-circle"></i> Mensajes y Campañas Ilimitadas</li><li><i ></i> Mensajes 100% Personalizados</li><li><i ></i>Adjunta Video, Imagen, Audio, Catálogos, Documentos</li> <li> <i></i>Importación de Contactos.</li> <li> <i></i>Sistema Anti-Algoritmo de Bloqueo</li>  <li> <i ></i>Envía Imágenes y Videos con Descripción</li><li> <i ></i>Programar campañas masivas</li><li> <i ></i>Gestión de contactos</li><li> <i ></i>Genera embudos de venta</li><li> <i ></i>ChatBot + WorkFlow + Menús</li><li> <i ></i>Crea Reglas Automatizadas</li> <li> <i ></i>Crea recordatorios recurrentes</li> <li> <i ></i>Agrega atributos personalizados CRM</li><li> <i ></i>Crea recordatorios y notas de trabajo</li><li><li> <i ></i>Crea respuestas rápidas</li><li> <i ></i>Genera Plantillas</li><li> <i ></i>Exporta e importa Backups</li><li> <span class="masc">Soporte 24/7</span></li><li><span class="masc">Actualizaciones GRATIS</span></li><li><span class="masc">Capacitación Personalizada</span></li></ul></div></div>',
    ...
    'C3':{
      items:{
         ...
         'I1':{
             ...
             detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li class="masc"><i ></i>10 Licencias</li><li><i class="fas fa-stop-circle"></i> Demos Ilimitadas</li><li><i ></i> Capacitación personalizada del negocio</li><li><i ></i> Comisiones 100%</li></ul></div></div>',
         ...
         'I2':{
             ...
             detalles:'<div class="contenedor-preguntas activo"><div class="contenedor-pregunta"><p class="pregunta">Ver Detalles<span class="icon-negocio ty"></span></p><ul class="features"><li><i></i> <span class="masc">Instalación GRATIS</span></li><li class="masc"><i ></i>100 Licencias</li><li><i class="fas fa-stop-circle"></i> Demos Ilimitadas</li><li><i ></i> Capacitación personalizada del negocio</li><li><i ></i> Comisiones 100%</li><li class="masc"><i ></i> Software con tu marca propia, colores, logo, números de contacto, links de redes sociales.</li></ul></div></div>',
...
//pepon
  ...
  var whatsapp_number ="&text=*Orden exitosa*" + "%0A"+"*CRM-Whats-2024*"+ "%0A"+"✅ *Detalle de la orden:*"+"%0A"+"_Orden N°_"+"%20"+ "%20"+"---"+"%20"+orden+"%20"+"---"+ "%0A"+"_________________________" + "%0A"+mostrarpedidof+ "%0A"+"*Total:*"+ "%20"+ "$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+ "%0A"+"_________________________"+ "%0A"+'*🙂Datos del Cliente:*'+ "%0A"+mostrarfac+"%20"+mostrarcedula+nombre+email+whatsapp+"%20"+"_________________________" +"%0A"+ retornapagos+cambio+"%0A"+fanlink+"%20"+"%0A"+"*Total:*"+ "%20"+"$"+`${(Number(delivery) + Number(totalfp.toFixed(2))).toFixed(2)}`+"%0A"+"%0A"+"*Orden N°:*"+ "%20"+orden;
...
var totaltrans= parseFloat(sbtotal.replace("$", ""));
  ...
  $('#masvendidos').insertBefore('#menu-container-C2');
    ...
    countdown('May 30 2024 23:59:59 GMT-0500', 'clock', '¡La Oferta ha expirado, contáctate con soporte!');
